...
export function ExplorerHero({ query, setQuery, onScan, loading }) {
  return (
    <motion.section
      ...
      className="relative"
    >
      <div className="overflow-hidden rounded-sentio-2xl border border-white/8 bg-(--surface-elevated)/90 shadow-sentio-md ring-1 ring-white/5 backdrop-blur-xl">
        <div className="border-b border-white/6 px-5 py-8 sm:px-8 sm:py-9">
