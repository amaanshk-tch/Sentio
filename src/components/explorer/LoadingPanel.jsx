  ...
  return (
    <Card className="overflow-hidden">
      <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="hidden items-center gap-2 rounded-full border border-white/8 bg-sentio-elevated/60 px-3 py-1.5 text-xs font-medium text-sentio-text-secondary sm:flex">
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-2">
        {[0, 1, 2, 3].map((i) => (
          <div
            key={i}
            className="rounded-sentio-xl border border-white/6 bg-sentio-elevated/35 p-5 ring-1 ring-white/3"
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-start gap-3">
                <div className="sentio-shimmer h-11 w-11 rounded-xl ring-1 ring-white/6" />
                <div className="space-y-2 pt-0.5">
                  <div className="sentio-shimmer h-3 w-28 rounded-md" />
                  <div className="sentio-shimmer h-6 w-20 rounded-md" />
                </div>
              </div>
              <div className="sentio-shimmer h-6 w-18 rounded-full" />
            </div>
          </div>
        ))}
      </div>
