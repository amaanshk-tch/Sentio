...
export function ExplorerNavbar({ onOpenHelp }) {
  return (
    <div className="fixed inset-x-0 top-0 z-50 border-b border-white/7 bg-sentio-canvas/70 backdrop-blur-2xl backdrop-saturate-150">
      <div className="mx-auto flex h-15 max-w-(--container-max) items-center justify-between gap-4 px-(--container-padding)">
        <BrandMark to="/" size="sm" />
        <div className="flex items-center gap-1 sm:gap-2">
          <span className="hidden items-center gap-2 rounded-full border border-white/8 bg-sentio-surface/50 px-2.5 py-1 text-[0.7rem] font-medium text-sentio-text-muted md:inline-flex">
          ...
          <a
            ...
            className={cn(
              ...
              "transition hover:bg-white/6 hover:text-sentio-text",
